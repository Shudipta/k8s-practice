...
type SharedInformerFactory interface {
	...
	Samplecrdcontroller() samplecrdcontroller_crd_com.Interface
}

func (f *sharedInformerFactory) Samplecrdcontroller() samplecrdcontroller_crd_com.Interface {
	return samplecrdcontroller_crd_com.New(f, f.namespace, f.tweakListOptions)
}
