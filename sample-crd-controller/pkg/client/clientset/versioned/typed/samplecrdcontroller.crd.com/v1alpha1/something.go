...
import (
	...
	scheme "github.com/shudipta/k8s-practice/sample-crd-controller/pkg/client/clientset/versioned/scheme"
...
func newSomethings(c *SamplecrdcontrollerV1alpha1Client, namespace string) *somethings {
	return &somethings{
		client: c.RESTClient(),
		ns:     namespace,
	}
