...
type FakeSomethings struct {
	Fake *FakeSamplecrdcontrollerV1alpha1
	ns   string
}

var somethingsResource = schema.GroupVersionResource{Group: "samplecrdcontroller.crd.com", Version: "v1alpha1", Resource: "somethings"}

var somethingsKind = schema.GroupVersionKind{Group: "samplecrdcontroller.crd.com", Version: "v1alpha1", Kind: "Something"}
